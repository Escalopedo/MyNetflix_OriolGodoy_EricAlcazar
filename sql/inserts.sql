...
INSERT INTO directores (nombre, fecha_nacimiento, descripcion, img) VALUES
  ...
  ('Zack Snyder', 1966, 'Director de películas de acción y superhéroes como 300 y Batman v Superman.', 'snyder.jpeg'),
  ...
  ('Brad Bird', 1957, 'Director de Los Increíbles y Ratatouille.', 'bird.jpeg'),
  ...
  ('Lana Wachowski y Lilly Wachowski', 1965, 'Hermanas directoras de la saga de The Matrix.', 'wachowski.webp'),
  ('Lee Unkrich', 1967, 'Director de Coco y editor en Toy Story.', 'unkrich.jpg'),
  ('James Wan', 1977, 'Director de El Conjuro y creador de la saga Saw.', 'wan.webp'),
...
INSERT INTO carteleras (titulo, descripcion, img, id_director) VALUES
  ...
  ('El Señor de los Anillos: La Comunidad del Anillo', 'Un joven hobbit llamado Frodo debe destruir un anillo mágico que posee un gran poder para evitar que caiga en manos malvadas.', 'señor_anillos_1.webp', 4),
  ('Harry Potter y la Piedra Filosofal', 'Un joven llamado Harry Potter descubre que es un mago y entra en una escuela mágica para aprender y enfrentar sus propios retos.', 'harry_potter_1.jpeg', 5),
  ...
  ('La La Land', 'Una joven aspirante a actriz y un pianista se enamoran mientras persiguen sus sueños en Los Ángeles.', 'la_la_land.jpeg', 12),
