...
<div id="modalEditarGenero" class="modal">
    <div class="modal-contenido">
        ...
        <form id="formEditarGenero">
            ...
            <p id="errorEditNombreGenero" class="error-message"></p>

            <!-- Botón de enviar (deshabilitado por defecto) -->
            <button type="submit" id="btnEditGenero" class="btn-tabla btn-success" disabled>Guardar Cambios</button>
        </form>
    </div>
</div>
...
<div id="modalCrearGenero" class="modal">
    <div class="modal-contenido">
        ...
        <form id="formCrearGenero">
            ...
            <input type="text" id="crearNombreGenero" name="nombre" onblur="validarNombreGenero()" oninput="validarFormularioGenero()">
            <p id="error-nombre" class="error-message"></p> 
            <!-- Botón de enviar (deshabilitado por defecto) -->
            <button type="submit" id="btnCrearGenero" class="btn-tabla btn-success crear-genero" disabled>Crear Género</button>
        </form>
    </div>
</div>
...
<div id="modalCrearCartelera" class="modal">
    <div class="modal-contenido">
        ...
        <p id="errorGeneral" class="error-message"></p>
            ...
            <p id="errorDirector" class="error-message"></p>
            ...
            <input type="file" id="crearImg" name="img" onblur="validarImagen()" onchange="validarFormulario()">
            <p id="errorImagen" class="error-message"></p>

            <!-- Botón de enviar (deshabilitado por defecto) -->
            <button type="submit" id="btnEnviar" class="btn-tabla btn-success" disabled>Crear Cartelera</button>
        </form>
    </div>
</div>    <script src="../js/ajaxUsuarios.js"></script>
